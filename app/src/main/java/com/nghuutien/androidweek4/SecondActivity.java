package com.nghuutien.androidweek4.SecondActivity;
...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String message = intent.getStringExtra(com.nghuutien.androidweek4.MainActivity.MainActivity.EXTRA_MESSAGE);
