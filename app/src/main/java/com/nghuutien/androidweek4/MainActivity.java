package com.nghuutien.androidweek4.MainActivity;
...
import com.nghuutien.androidweek4.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void launchSecondActivity(View view) {
        ...
        Intent intent = new Intent(this, com.nghuutien.androidweek4.SecondActivity.SecondActivity.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == TEXT_REQUEST) {
            ...
            if (resultCode == RESULT_OK) {
                String reply = data.getStringExtra(com.nghuutien.androidweek4.SecondActivity.SecondActivity.EXTRA_REPLY);
